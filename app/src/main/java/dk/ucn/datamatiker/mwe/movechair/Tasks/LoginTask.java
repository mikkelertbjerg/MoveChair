...
public class LoginTask extends AsyncJsonTask<UserModel> {
    ...
    public LoginTask(AsyncJsonTask.AsyncJsonResponse delegate, Type type, String email) {
        super(delegate, type);
        this.email = email;
    ...
    protected UserModel doInBackground(Object[] objects) {
        ...
        HttpUriRequest request = RequestBuilder.get()
                .setUri("http://jvo-web.dk/index.php?controller=" + this.controller + "&email=" + this.email)
