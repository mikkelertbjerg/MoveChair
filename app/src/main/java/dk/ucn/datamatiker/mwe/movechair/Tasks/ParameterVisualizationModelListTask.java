...
public class ParameterVisualizationModelListTask extends AsyncJsonTask<List<ParameterVisualizationModel>> {

    private AsyncJsonResponse delegate;

    public ParameterVisualizationModelListTask(AsyncJsonResponse delegate, Type type) {
        super(delegate, type);
