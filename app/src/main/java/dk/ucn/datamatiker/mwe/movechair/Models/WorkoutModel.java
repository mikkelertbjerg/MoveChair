...
public class WorkoutModel extends ActivityModel implements Serializable {
    ...
    public WorkoutModel(String name, String description, int id, ActivityTypeModel activityType, double points, double duration, List<MediaModel> media, List<ExerciseModel> exercises, double restDuration, DifficultyModel difficulty, int kcal) {
    ...
    public WorkoutModel(String name, String description, int id, ActivityTypeModel activityType, double points, double duration, List<MediaModel> media, int kcal) {
        super(name, description, id, activityType, points, duration, media, kcal);
    }
