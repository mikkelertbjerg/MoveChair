...
public class MyPlanFragment extends Fragment {
    ...
    private MyPlanViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(MyPlanViewModel.class);
        // TODO: Use the ViewModel
        WorkoutPlanModel wp = (WorkoutPlanModel)mViewModel.getMyPlan(1);
