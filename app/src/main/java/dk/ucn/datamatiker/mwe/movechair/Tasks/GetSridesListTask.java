...
public class GetSridesListTask extends AsyncJsonTask<List<StridesModel>> {
    ...
    @Override
    protected List<StridesModel> doInBackground(Object[] object) {
        ...
        List<StridesModel> result = null;
        String myUrl = "http://jvo-web.dk/index.php?controller="+ this.controller.replace("Model", "") +"&action=selectallstridesfromuser&user_id=" + this.user_id;
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                Type listType = null;
                //List type
                listType = new TypeToken<List<StridesModel>>() {}.getType();
